...
static lv_fs_res_t fs_open (lv_fs_drv_t * drv, void * file, const char * path, lv_fs_mode_t mode);
...
static lv_fs_res_t fs_write(lv_fs_drv_t * drv, void * file, const void * buf, uint32_t btw, uint32_t * bw);
static lv_fs_res_t fs_seek (lv_fs_drv_t * drv, void * file, uint32_t pos);
static lv_fs_res_t fs_size (lv_fs_drv_t * drv, void * file, uint32_t * size_p);
static lv_fs_res_t fs_tell (lv_fs_drv_t * drv, void * file, uint32_t * pos_p);
static lv_fs_res_t fs_remove (lv_fs_drv_t * drv, const char *path);
static lv_fs_res_t fs_trunc (lv_fs_drv_t * drv, void * file);
 ...
 * @param file pointer to a file_t variable
 ...
 * @param drv pointer to a driver where this function belongs
 * @param file pointer to a file_t variable. (opened with lv_ufs_open)
 ...
 * @param drv pointer to a driver where this function belongs
 * @param file pointer to an 'ufs_file_t' variable. (opened with lv_fs_open )
 * @return LV_FS_RES_OK: no error, the file is read
 *         any error from lv_fs_res_t enum
 */
static lv_fs_res_t fs_trunc (lv_fs_drv_t * drv, void * file)
