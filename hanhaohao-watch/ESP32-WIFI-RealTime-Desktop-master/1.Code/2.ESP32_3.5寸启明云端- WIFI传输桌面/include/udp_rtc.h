...
void digitalClockDisplay()
{
  ...
  lv_table_set_cell_value(table, 0, 1, timedate);sprintf(timedate, "%d",month());
  lv_table_set_cell_value(table, 1, 1, timedate);sprintf(timedate, "%d",day());
  lv_table_set_cell_value(table, 2, 1, timedate);
