...
namespace ScreenShotSender
{
    public partial class FormSenderMain : Form
    {
        ...
        private void FormSenderMain_Shown(object sender, EventArgs e)
        {
            ...
            /* 原本的图像采集框大小 */
            //formCaptureBox.Width = 240 * dpiX / 96;
            //formCaptureBox.Height = 135 * dpiY/ 96;

            /* 设置图像采集框大小 */
            formCaptureBox.Width = 240;
            formCaptureBox.Height = 135;
        ...
        private void tlpHost_Paint(object sender, PaintEventArgs e)
        {
