...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partition.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partition.csv"
...
#define CONFIG_LV_DISP_DEF_REFR_PERIOD 5
